...
const FEATURES = [
  ...
  },
  {
    ...
    paragraph:
      "Make inventory management effortless with RepairDesk’s powerful inventory management software that simplifies inventory tracking, ordering, and replenishment. Easily create a serialized inventory, Purchase Orders and GRNs, transfer your inventory from one store to another and perform inventory counts.",
  },
  {
  ...
  },
  {
    ...
    paragraph:
      "Stay connected with your customers effortlessly using RepairDesk’s SMS and email notification feature. Instantly send automated updates, reminders, and notifications to keep customers informed every step of the way. Customize messages to reflect your brand and improve communication efficiency.",
  },
  {
