...
const CheckMark = () => (
  <svg className="w-5 h-5 text-blue-500 mx-auto" viewBox="0 0 20 20" fill="currentColor">
...
export default function ComparisonTable({ companyA = 'AA Repairdesk', companyB, features = [] }) {
  return (
