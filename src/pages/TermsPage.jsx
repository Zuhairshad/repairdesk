...
const terms = [
  {
    ...
    content: 'By accessing or using AA Repairdesk services, you agree to be bound by these Terms and Conditions. If you disagree with any part of these terms, you may not access the service. These terms apply to all visitors, users, and others who access or use the service. Use of AA Repairdesk constitutes acceptance of both these Terms and our Privacy Policy.',
  },
  {
    title: 'Account Registration',
    plain: 'You are responsible for your account.',
    content: 'You must register for an account to use most AA Repairdesk features. You are responsible for safeguarding your password and for all activities that occur under your account. You agree to notify us immediately at hello@aarepairdesk.co of any breach of security or unauthorised use. AA Repairdesk reserves the right to suspend accounts that violate these terms.',
  },
  {
    title: 'Subscription & Billing',
    plain: 'We bill monthly or annually. Cancel any time.',
    content: 'AA Repairdesk is offered on a subscription basis billed monthly or annually. Subscriptions automatically renew unless cancelled before the renewal date. All fees are exclusive of applicable taxes. Annual plan refunds are prorated for unused months when requested within 30 days of the billing date. We reserve the right to change pricing with 30 days notice.',
  },
  {
    title: 'Permitted Use',
    plain: "Use AA Repairdesk for your repair business — don't misuse it.",
    content: 'You may use AA Repairdesk solely for your repair shop business operations. You agree not to reproduce, duplicate, copy, sell, or resell any portion of the service without written consent from AA Repairdesk. Prohibited uses include scraping data, attempting to gain unauthorised access, transmitting malware, or using the service in a way that could impair its functionality.',
  },
  {
    title: 'Intellectual Property',
    plain: 'AA Repairdesk owns the platform; you own your data.',
    content: 'The AA Repairdesk platform, including all content, features, and functionality, is owned exclusively by AA Repairdesk Inc. and is protected by copyright, trademark, and other applicable laws. You retain full ownership of all data you input into AA Repairdesk — your customer records, tickets, and inventory belong to you. You may export your data at any time.',
  },
  {
    title: 'Data Ownership & Privacy',
    plain: 'Your data is yours. We are the stewards, not the owners.',
    content: 'All data you enter into AA Repairdesk — customer records, repair tickets, inventory, financial reports — is owned by you. AA Repairdesk processes this data only to provide the service as described in our Privacy Policy. We do not sell, share, or monetise your data. You may request a full export of your data at any time, and we will provide it within 5 business days.',
  },
  {
    title: 'Service Availability',
    plain: 'We aim for 99.9% uptime but cannot guarantee it.',
    content: 'AA Repairdesk targets 99.9% monthly uptime, excluding scheduled maintenance. We will provide at least 24 hours notice for planned downtime. In the event of unplanned outages, we will communicate status at status.aarepairdesk.co. Service interruptions do not entitle users to refunds unless they exceed 24 consecutive hours in a billing month.',
  },
  {
    title: 'Limitation of Liability',
    plain: 'Our liability is capped at what you paid us in the last 12 months.',
    content: "To the maximum extent permitted by law, AA Repairdesk's liability for any claim arising from your use of the service is limited to the amount you paid us in the 12 months preceding the claim. AA Repairdesk is not liable for indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunities.",
  },
  {
    title: 'Termination',
    plain: 'Either party can terminate with notice.',
    content: 'You may cancel your subscription at any time from your account settings. AA Repairdesk may terminate or suspend your account immediately if you breach these terms or engage in activity that harms the platform or other users. Upon termination, your data remains accessible for 90 days for export, after which it is permanently deleted.',
  },
  {
    title: 'Governing Law',
      ...
      <section className="bg-white border-b border-gray-100 py-20 px-6">
        <div className="container-main max-w-4xl">
          ...
          <p className="text-gray-600 font-dm-sans text-base mb-4">
            These terms govern your access to and use of AA Repairdesk software. Please read them carefully.
          </p>
      ...
      <section className="py-14 px-6 bg-white">
        <div className="container-main max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:legal@aarepairdesk.co" className="inline-flex items-center gap-2 bg-rd-teal text-white font-poppins font-semibold text-sm px-6 py-3 rounded-xl hover:bg-rd-dark transition-colors">
              legal@aarepairdesk.co
            </a>
