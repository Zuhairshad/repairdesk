...
const rights = [
  ...
  { title: 'Right Not to Be Subject to Automated Decisions', desc: 'RepairDesk does not make legally significant automated decisions about individuals.' },
];
        ...
        <div className="container-main max-w-4xl">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
            ...
            <p className="font-dm-sans text-gray-500 text-sm leading-relaxed">
              RepairDesk Inc., 108 W 13th St, Wilmington, DE 19801, USA is the data controller for personal data processed through the RepairDesk platform. For EU/EEA customers, we process data under Article 6(1)(b) GDPR (contract performance) and Article 6(1)(f) (legitimate interests) as primary lawful bases.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-main max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:privacy@repairdesk.co" className="inline-flex items-center gap-2 bg-rd-teal text-white font-poppins font-semibold text-sm px-6 py-3 rounded-xl hover:bg-rd-dark transition-colors">
              <IconMail />privacy@repairdesk.co
            </a>
