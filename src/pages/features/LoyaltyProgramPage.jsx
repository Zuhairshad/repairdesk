...
const journeySteps = [
  ...
  },
  {
    ...
    desc: 'RepairDesk automatically credits loyalty points to their account.',
...
const faqs = [
  ...
  { q: "How do I check for a customer's available loyalty points?", a: "The loyalty points for a customer will be visible on the customer information section of the POS once you've selected them, and in the Customer section of your RepairDesk account. You should be able to view their remaining loyalty points from here." },
  ...
  { q: 'Are there any extra charges to using the loyalty program feature?', a: 'The loyalty program feature is part of your subscription to the RepairDesk Enterprise package. If you would like to add store credits to your repair business, please consider signing up.' },
  { q: 'Do you offer customer support?', a: 'We have excellent customer support & you are always prioritized above anything and everything. If you ever run into a problem or cannot find what you are looking for, you can give us a call, chat with one of product specialists, or send us an email at support@repairdesk.co.' },
];
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main grid md:grid-cols-[280px_1fr] gap-12">
          <div>
            ...
            <p className="text-gray-500 font-dm-sans text-sm leading-relaxed">Everything repair shop owners ask us before switching their loyalty program to RepairDesk.</p>
            <div className="mt-8 bg-rd-dark rounded-2xl p-5 hidden md:block">
              ...
              <p className="text-white/60 text-xs font-dm-sans mt-1">support@repairdesk.co</p>
            </div>
          </div>
