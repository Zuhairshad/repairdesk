...
const faqs = [
  ...
  { q: 'Does it integrate with our payroll provider?', a: 'AA Repairdesk exports timesheets in standard CSV and PDF formats compatible with QuickBooks, Xero, Gusto, ADP, and others. You can also use direct API integrations to push approved timesheets straight to your payroll system without any manual file handling.' },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative bg-rd-cream rounded-2xl p-1 shadow-lg overflow-hidden aspect-[4/3]">
              <svg viewBox="0 0 480 360" fill="none" className="w-full h-full">
                ...
                <text x="240" y="210" textAnchor="middle" fill="#3d405b" fontSize="10" fontWeight="700" fontFamily="sans-serif">AA Repairdesk HQ</text>
                {/* Employee pins */}
