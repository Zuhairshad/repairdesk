          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://app.aarepairdesk.co/register" className="btn-primary px-8 py-3.5 shadow-lg shadow-rd-teal/25">Start Free Trial</a>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-gray-500 font-dm-sans leading-relaxed text-sm">
                  Every repair shop is different. Configure the kiosk form fields, upload your branding, set repair terms, and add a pre-repair checklist — all from AA Repairdesk settings.
                </p>
              </div>
