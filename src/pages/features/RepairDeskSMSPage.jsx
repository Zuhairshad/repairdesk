...
const faqs = [
  { q: 'How does the SMS credit system work?', a: 'RepairDesk uses a prepaid credit model. Purchase credits in bundles from your dashboard — domestic US/Canada messages cost about 1-2 credits each, international varies by country. Credits never expire, there are no monthly minimums, and you can set up auto-refill so you never run dry mid-campaign.' },
  { q: 'Can customers reply to automated messages?', a: 'Absolutely. Every automated SMS supports two-way replies. Customer responses land in your RepairDesk inbox as threaded conversations tied to their ticket. Your team can reply from the dashboard — no personal phone numbers needed, no context lost.' },
  { q: 'How do I connect my Twilio account?', a: 'Go to Settings → Integrations → Twilio in your RepairDesk dashboard. Enter your Twilio Account SID, Auth Token, and a verified phone number. RepairDesk handles the rest — message routing, delivery tracking, and compliance. You can also use RepairDesk\'s built-in SMS without Twilio.' },
  ...
  { q: 'Is there an opt-in and compliance system?', a: 'RepairDesk includes built-in TCPA and GDPR-compliant opt-in management. Customers opt in during check-in (digital signature capture), and every outbound SMS includes an opt-out keyword. Opt-out requests are processed automatically and logged for your records.' },
];
    ...
    <PageLayout>
        ...
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
          <div>
            ...
            <p className="text-white/60 text-lg font-dm-sans leading-relaxed mb-8 max-w-lg">
              Automated SMS keeps customers informed from check-in to pickup. Two-way conversations, marketing campaigns, and analytics — all inside RepairDesk.
            </p>
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-gray-500 font-dm-sans text-lg leading-relaxed mb-6">
                Customers reply right from their phone. Your team responds from the RepairDesk dashboard. No personal numbers, no app installs, no missed messages — just a threaded conversation tied to every ticket.
              </p>
      ...
      <section className="bg-rd-dark py-16 px-6">
        <div className="container-main max-w-3xl text-center">
          <h2 className="font-poppins font-bold text-2xl md:text-3xl text-white mb-3">Powered by Twilio. Managed by RepairDesk.</h2>
          <p className="text-white/50 font-dm-sans mb-8 max-w-lg mx-auto">
            Connect your Twilio account for full control, or use RepairDesk's built-in SMS — no external account required. Compliance, opt-in management, and delivery tracking are handled automatically.
          </p>
      ...
      <section className="bg-rd-cream py-20 px-6">
        <div className="container-main max-w-3xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 font-dm-sans">Everything you need to know about RepairDesk SMS.</p>
          </div>
