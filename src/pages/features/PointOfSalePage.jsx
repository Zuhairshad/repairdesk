...
const faqs = [
  ...
  },
  {
    ...
    a: 'Absolutely. RepairDesk POS handles both retail sales and repair services. You can sell accessories, pre-owned devices, gift cards, and prepaid PINs all from the same checkout screen.',
  },
  {
    q: 'Is there a free trial available?',
    a: 'Yes, RepairDesk offers a free trial so you can explore all the POS features, set up your inventory, and see how it works with your workflow before committing.',
  },
];
              ...
              <div className="relative w-72 h-80">
                ...
                <div className="absolute bottom-12 left-0 right-0 h-44 rounded-2xl bg-gradient-to-br from-rd-lime to-[#c5e86a] shadow-xl p-6 flex flex-col justify-between">
                  <div className="flex justify-between items-start">
                    <div className="font-poppins font-bold text-rd-dark text-lg">RepairDesk</div>
                    {/* Contactless icon */}
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-dm-sans text-gray-500 leading-relaxed mb-8">
                Boost your average order value without extra effort &mdash; RepairDesk suggests accessories, bundles, and group discounts right at the point of sale.
              </p>
            ...
            <ReceiptCard>
              ...
              <div className="border-t border-dashed border-gray-300 pt-6">
                <p className="font-dm-sans text-gray-600 text-sm leading-relaxed italic">
                  "RepairDesk has completely transformed how we run our shop. From ticketing to payments to inventory &mdash; everything is in one place and it just works. I wouldn't go back to our old system for anything."
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="font-dm-sans text-gray-500 leading-relaxed mb-6">
                Everything you need to know about RepairDesk's POS system. Can't find an answer?
              </p>
