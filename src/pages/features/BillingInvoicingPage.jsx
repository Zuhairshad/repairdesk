...
const faqData = [
  {
    ...
    a: 'Yes. When you close or update a ticket, RepairDesk auto-generates an invoice pre-filled with line items, labor charges, taxes, and any parts used. You can email it with a payment link in one click.',
  },
  {
  ...
  {
    q: 'Which accounting platforms does RepairDesk integrate with?',
    a: 'RepairDesk offers two-way sync with both QuickBooks Online and Xero. Invoices, payments, refunds, and tax data flow automatically so your books are always up to date without double entry.',
  },
  {
    q: 'Does RepairDesk support multi-currency billing?',
  ...
  },
  {
    ...
    a: 'Each emailed invoice contains a unique secure link. When customers click it, they see the invoice details and can pay using credit card, debit card, or other enabled payment methods. The payment status updates in RepairDesk in real time.',
  },
];
    ...
    <PageLayout>
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-500 font-dm-sans text-center text-lg mb-16 max-w-2xl mx-auto">Every repair follows the same money trail. RepairDesk automates each step so nothing slips through the cracks.</p>
        ...
        <div className="container-main">
          ...
          <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0">
            ...
            <div className="bg-rd-dark rounded-2xl px-8 py-6 text-center shrink-0">
              ...
              <div className="font-poppins font-bold text-white text-lg">RepairDesk</div>
          ...
          <div className="max-w-md w-full">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-t-2xl px-8 pt-8 pb-6">
              ...
              <div className="border-b-2 border-dashed border-gray-300 pb-4 mb-5 text-center">
                ...
                <div className="text-[10px] font-dm-sans text-gray-300">Verified RepairDesk User</div>
              </div>
              <blockquote className="font-dm-sans text-rd-dark text-base leading-relaxed mb-6 text-center">
                "We used to spend an hour every evening reconciling invoices. With RepairDesk, invoices generate from tickets automatically, customers pay through the emailed link, and everything syncs to QuickBooks. We literally saved 30 hours a month."
              </blockquote>
      ...
      <section className="bg-rd-cream py-20 px-6">
        <div className="container-main max-w-3xl">
          ...
          <p className="text-gray-500 font-dm-sans text-center text-lg mb-12">Everything you need to know about billing and invoicing in RepairDesk.</p>
