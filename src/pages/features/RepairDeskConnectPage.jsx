...
const faqs = [
  ...
  { q: 'Is internal team chat included at no extra cost?', a: 'Internal messaging is built into every RepairDesk Connect plan. Your technicians can tag colleagues, share notes on a ticket, and escalate issues — all inside the same interface where customer messages live. No separate chat tool required.' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="font-dm-sans text-lg text-white/75 leading-relaxed mb-10 max-w-lg">
                RepairDesk Connect brings SMS, email, and internal team chat into a single threaded conversation view — so no customer message falls through the cracks.
              </p>
