...
const GoogleGIcon = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className={className}>
    ...
    <path fill="#4285F4" d="M24 44c5.3 0 10.2-2 13.9-5.4l-6.4-5.4C29.5 34.7 26.9 36 24 36c-5.4 0-9.9-3.4-11.3-8.1l-6.5 5C9.5 39.6 16.2 44 24 44z" />
...
const automationSteps = [
  ...
  },
  {
    ...
    description:
      'All reviews can be accessed from within the AA Repairdesk Connect App. Check reviews directly on your dashboard and monitor your online rating.',
...
const faqs = [
  {
    ...
    a: 'Google Review automation through SMS is offered as an Add-on and can be obtained independently by subscribers to both the Essential and Growth plans. All clients who subscribe to AA Repairdesk Connect receive Google review automation via SMS free of charge.',
  },
  {
    q: "Which countries are supported by AA Repairdesk's Google Review automation via SMS?",
    a: 'At the moment, the Google Review automation through SMS service offered by AA Repairdesk is only available to AA Repairdesk merchants situated in the US, Canada, Australia, and the UK.',
  },
  {
  ...
  },
  {
    ...
    a: 'At this time, you are required to pay separately for virtual numbers and SMS credits. If you are utilizing AA Repairdesk Phone System service in either the United States or Canada, you will be eligible to receive a complimentary allotment of one thousand SMS credits.',
  },
];
        ...
        <div className="container-main">
          <div className="max-w-2xl mb-14">
            ...
            <p className="font-dm-sans text-gray-600 text-lg leading-relaxed">
              AA Repairdesk Google Review Automation System takes the hassle out of generating and managing reviews. Nate from ScreenFixing, a leading cell phone repair shop in Atlanta, Georgia, tested it out for a few months. The results? Mind-blowing.
            </p>
          </div>
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="container-main">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="font-dm-sans text-gray-600 text-lg leading-relaxed">
              With the AA Repairdesk review generation and monitoring tool, you can collect 5-star feedback for every successful repair job completed. Whether you're a small local repair shop or a large-scale operation, you can automate the process and enjoy the benefits.
            </p>
          </div>
      ...
      <section className="bg-rd-cream py-20 md:py-28">
        <div className="container-main">
          <h2 className="font-dm-serif text-3xl md:text-4xl text-rd-dark text-center max-w-3xl mx-auto mb-16 leading-snug">
            AA Repairdesk Reviews Automation Tool is Popular Among Repair Businesses
          </h2>
