...
const faqs = [
  { q: 'Can customers redeem gift cards at any of my locations?', a: 'Yes. RepairDesk gift cards work across every store linked to your account. A card sold at one location can be redeemed at any other, making them perfect for multi-location repair businesses.' },
        ...
        <div className="container-main relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 max-w-xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://app.repairdesk.co/register" className="btn-primary px-8 py-3.5 shadow-lg shadow-rd-teal/20">Start Free Trial</a>
        ...
        <div className="container-main">
          <div className="flex flex-col lg:flex-row items-center gap-14 max-w-5xl mx-auto">
            <div className="flex-1">
              ...
              <p className="font-dm-sans text-gray-500 leading-relaxed mb-6">Stores using RepairDesk gift cards see an average 23% increase in repeat visits. Gift card holders spend 20% more per transaction than cash customers.</p>
        ...
        <div className="container-main relative z-10 max-w-4xl">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1">
              ...
              <a href="https://app.repairdesk.co/register" className="inline-flex items-center gap-2 bg-[#f0d78c] text-rd-dark px-7 py-3 rounded-full font-poppins font-semibold hover:bg-[#e8c96e] transition-colors text-sm">
                Get Started Free
