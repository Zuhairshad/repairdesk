...
export default function JobNotificationsPage() {
  ...
  return (
    <PageLayout>
      ...
      <section className="relative bg-rd-dark overflow-hidden py-28 px-6">
        ...
        <div className="container-main relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="relative shrink-0">
            <div className="w-56 h-56 md:w-64 md:h-64 rounded-full bg-gradient-to-br from-rd-teal to-[#2d2f45] flex items-center justify-center shadow-2xl shadow-rd-teal/20">
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main">
          <div className="bg-gradient-to-br from-rd-dark to-[#1e2035] rounded-3xl p-10 md:p-16 text-white overflow-hidden relative">
            {/* Decorative ring */}
