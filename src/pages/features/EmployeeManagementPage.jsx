...
const overviewFeatures = [
  ...
  },
  {
    ...
    desc: 'Roles are the quickest and easiest way to manage employee permissions. Define, set, and implement different employee roles and permissions to control their access to AA Repairdesk.',
    icon: 'shield',
  },
  {
...
const faqs = [
  {
    q: 'Does AA Repairdesk Employee Management feature work on my mobile or tablet?',
    a: 'You can access the AA Repairdesk web app from your mobile and tablet.',
  },
  {
  ...
  },
  {
    ...
    a: "You can keep in touch with your employees via the Slack integration of AA Repairdesk's employee management software for your repair shop.",
  },
  {
  ...
  {
    q: 'Does AA Repairdesk have a payroll integration?',
    a: "Yes, AA Repairdesk has a payroll integration that allows you to set your employee's hourly or monthly pay rate. You can also add the commission feature for your employees.",
  },
];
        ...
        <div className="container-main grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="text-white/80 text-lg font-dm-sans leading-relaxed mb-8">
              ...
              <Link to="/features/reporting" className="text-rd-mint underline hover:text-white transition-colors">Reporting</Link> feature.
            </p>
          ...
          <div className="relative bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
            <div className="flex flex-col items-center">
              <div className="w-full max-w-[240px] bg-rd-lime text-white rounded-xl px-5 py-4 flex items-center gap-3 shadow-lg">
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-5 mt-6 pt-6 border-t border-white/25 w-full">
                {orgChart.map((emp) => (
                  <div key={emp.role} className="relative flex flex-col items-center text-center">
                    ...
                    <span className={`inline-flex items-center gap-1 text-[10px] font-dm-sans px-2 py-0.5 rounded-full ${emp.status === 'Clocked In' ? 'bg-rd-lime/20 text-rd-mint' : 'bg-white/15 text-white/70'}`}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={row.name} className="flex items-center justify-between border border-gray-100 rounded-xl px-4 py-3">
                    ...
                    <span className={`text-[11px] font-dm-sans px-2.5 py-1 rounded-full shrink-0 ${row.state === 'Clocked In' ? 'bg-blue-50 text-[#457b9d]' : row.state === 'On Break' ? 'bg-amber-50 text-amber-600' : 'bg-gray-100 text-gray-500'}`}>{row.state}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 bg-rd-dark rounded-2xl p-6 md:p-8 text-white">
              <div className="flex items-center gap-2 mb-6">
                <Icon name="wallet" className="w-5 h-5 text-rd-mint" />
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={row.name} className="flex items-center justify-between text-sm border-b border-white/10 pb-3">
                    ...
                    <span className="font-poppins font-semibold text-rd-mint">{row.total}</span>
                  </div>
                ))}
              </div>
              <div className="flex items-center justify-between mt-5 pt-1">
                <span className="font-poppins font-semibold text-sm">Total Payroll</span>
                <span className="font-poppins font-bold text-lg text-rd-mint">$1,547.00</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center mb-6">
                <Icon name="cloud" className="w-7 h-7 text-rd-mint" />
              </div>
              <span className="block text-[10px] font-bold uppercase tracking-widest text-rd-mint mb-3">Secure Staff Records</span>
            ...
            <div className="bg-white/10 border border-white/15 rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-5">
                <Icon name="shield" className="w-5 h-5 text-rd-mint" />
          ...
          <div className="bg-rd-cream rounded-2xl p-8 md:p-12 grid grid-cols-1 lg:grid-cols-[auto,1fr] gap-8 items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 font-dm-sans text-lg leading-relaxed italic mb-6">
                "I like that I can check the status of all repair jobs and see what needs to be done and I can track who's been doing what. I have also added the feature where the system asks the employees to sign-in every time they try to do something, now everybody is accountable for the things they are doing. So I can easily keep a check on everything at the old store through AA Repairdesk reporting, while I'll be away at the new one."
              </p>
