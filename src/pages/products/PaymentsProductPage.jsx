...
const faqs = [
  {
    ...
    a: 'None beyond what you already have. AA Repairdesk Payments works with your existing POS setup. For tap-to-pay, we ship a compact chip + contactless reader that plugs right in — no separate terminal contract required.',
  },
  {
  ...
  },
  {
    ...
    a: 'Absolutely. AA Repairdesk Payments is fully PCI-DSS Level 1 compliant with end-to-end encryption and tokenization. Card data never touches your local systems — it is encrypted at the reader and decrypted only by the payment processor.',
  },
  {
...
const flowSteps = [
  ...
  },
  {
    ...
    desc: 'Every transaction ties back to the ticket inside AA Repairdesk.',
    color: 'bg-rd-dark',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="font-dm-sans text-gray-600 text-lg mb-8 leading-relaxed">
                Chip cards, contactless tap, Apple Pay, Google Pay, magnetic swipe — the AA Repairdesk reader handles them all. No juggling terminals from different providers.
              </p>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="font-dm-sans text-gray-500 text-lg">
              See how AA Repairdesk Payments stacks up against legacy processors.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-3 gap-0 text-center font-dm-sans text-sm text-gray-400 mb-3 px-4">
              ...
              <span className="font-poppins font-semibold text-rd-teal">AA Repairdesk</span>
