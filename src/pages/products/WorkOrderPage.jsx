...
const streamlineFeatures = [
  ...
  },
  {
    ...
    description: 'Track the status of repair jobs and keep customers updated in real time. RepairDesk work order software automates workflows and modernizes repair management.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description: "RepairDesk work order and inventory management software helps you keep tabs on available parts and accessories so you're always stocked up.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const insightTiles = [
  {
    ...
    description: 'Manage your employees, evaluate performance, and process payroll — RepairDesk work order management software does it all without any errors.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description: 'Define, set, and implement employee roles and permissions to control exactly what your team can access inside RepairDesk.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const testimonials = [
  {
    quote: 'Our technicians used to lose track of which jobs were waiting on parts. With RepairDesk work orders and custom statuses, everyone on the floor knows exactly where every device stands at all times.',
    name: 'Jason Tran',
...
const faqs = [
  {
    ...
    a: 'Share your business details with us by filling out the form. A product specialist will reach out to you to give a complete consultation on how to set up your repair shop using RepairDesk Work Order Management software.',
  },
  {
  ...
  {
    q: 'Can I Integrate RepairDesk with other Platforms?',
    a: 'Yes, RepairDesk work order software can be integrated with 40+ platforms, including WooCommerce, Shopify, QuickBooks, Xero, ShipStation, and many more.',
  },
  {
    q: 'How much does RepairDesk subscription cost?',
    a: 'RepairDesk subscription starts from as low as $99/store/month for five users. It goes up from there depending on your number of users, your chosen plan, and any add-ons you select.',
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            <div>
              ...
              <p className="font-dm-sans text-lg text-white/80 mb-8 leading-relaxed">
                A reliable and powerful work order management system to meet all your repair business requirements. Create tickets, assign jobs to repair technicians, track repair status, organize your inventory, and streamline all the repair management processes with RepairDesk.
              </p>
        ...
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="font-dm-sans text-gray-600 text-lg">
              RepairDesk work order system for small businesses lets you automate and manage end-to-end operations at your repair shop. Create repair tickets, communicate with your employees, and enable them to finish the repair job quickly — no more manual data entry.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="font-dm-sans text-gray-600 text-lg leading-relaxed mb-8">
                With RepairDesk work order software, track the complete performance of your business — repair jobs, employee activity, sales, and revenue. Streamline everything from inventory management to payroll to repair job history, check repair statuses, monitor employee productivity, and get business reports with rich, advanced modules.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 text-white">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="font-dm-sans text-white/80 leading-relaxed">
                Whether you're a multi-store operation or a franchise, RepairDesk work order software connects every location you manage. Transfer inventory between stores and keep an accurate record of every part and accessory as you grow from a single store to multiple franchises.
              </p>
            </div>
        ...
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="font-dm-serif text-3xl md:text-4xl text-rd-dark mb-4">
              Repair Shops Running on RepairDesk
            </h2>
            <p className="font-dm-sans text-gray-600 text-lg">
        ...
        <div className="container-main">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="font-dm-sans text-gray-600 text-center mb-12">
              Common questions about RepairDesk's work order management software.
            </p>
            <div className="space-y-4">
              {faqs.map((faq) => (
