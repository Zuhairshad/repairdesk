...
const channels = [
  ...
  {
    title: 'Two-way Email',
    description: 'Integrate your business email account with RepairDesk Connect and receive all the emails in your unified inbox.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const efficiency = [
  ...
  {
    title: 'Save Time',
    description: 'No more tab switching. Goodbye context switching. Stop feeling like a mess, and start winning with RepairDesk Connect.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const experience = [
  {
    ...
    description: 'Get notification alerts within RepairDesk and never miss a vital call or message from your customers.',
    icon: (
  ...
  },
  {
    ...
    description: 'Explore the potential of our deep integration with RepairDesk POS by assigning chats to employees so they can respond to queries faster.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
      </svg>
...
const faqs = [
  {
    q: 'How to purchase RepairDesk Connect for my RepairDesk POS?',
    a: 'You can get a 7 day free trial to RepairDesk Connect by filling the form above. Once you\'re happy with the experience, you can enable subscription from the Billing Module at any time.',
  },
  {
    q: 'Do I need to upgrade my RepairDesk plan to enable RepairDesk Connect?',
    a: 'RepairDesk Connect is available as an add-on and can be purchased separately by Essential and Growth paid subscription plan users. It is included in the Advanced package.',
  },
  {
  ...
  },
  {
    ...
    a: 'We have excellent customer support and you are always prioritized above anything and everything. If you ever run into a problem, you can give us a call, chat with one of our product specialists, or email us at support@repairdesk.co',
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6">
              ...
              <p className="font-dm-sans text-lg md:text-xl text-white/80 mb-10 leading-relaxed">
                Manage your emails, texts, and social messages from one inbox inside RepairDesk. Reply to customers in real-time with live chat, and turn more inquiries into booked repairs, all in one screen.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5">
              ...
              <p className="font-dm-sans text-gray-600 text-lg leading-relaxed mb-8">
                Reduce the hassle of cross platform communication and enjoy the powerful feature set of RepairDesk Connect.
              </p>
        ...
        <div className="container-main">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="font-dm-sans text-xl md:text-2xl leading-relaxed mb-8 text-white/90">
              "RepairDesk Connect seems to be a great feature, excellent service by Musa — he goes beyond for my help. I'm not an IT person but he explains in a very professional and friendly manner, best recommended feature so far."
            </p>
            <div>
              <div className="font-poppins font-semibold text-rd-lime">Catherine Morris Hinerman</div>
              <div className="font-dm-sans text-white/60 text-sm mt-1">RepairDesk Connect Customer</div>
            </div>
          </div>
        </div>
      </section>
