...
const abcSteps = [
  {
    ...
    body: 'Your repair categories are pulled straight from AA Repairdesk — nothing to rebuild.',
  },
  {
    letter: 'B',
  ...
  },
  {
    ...
    body: 'Issues and their prices match your AA Repairdesk account exactly, so quotes are always accurate.',
  },
];
...
const faqs = [
  {
    q: 'How do I install Appointments Pro in AA Repairdesk?',
    a: 'Open AA Repairdesk and click the "+" icon on the right side. Choose "Appointments Pro" from the list of applications and click "Install." The "Appointments Pro" icon will then appear on the right side.',
  },
  {
    q: 'Can I get a free trial of Appointments Pro?',
    a: "By filling out the form above, you can get a 7-day free trial to AA Repairdesk Appointments Pro. Once you're happy with the experience, you can enable a subscription from the Billing Module anytime.",
  },
  {
  ...
  },
  {
    ...
    a: 'When a customer requests a quote or books an appointment, a lead appears on the "Leads and Appointments" page with their name and contact information. If Sync with AA Repairdesk is enabled, you can also view the lead in AA Repairdesk’s Leads section, where you can send messages or start repair tickets.',
  },
];
        ...
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="font-dm-sans text-gray-600 text-lg leading-relaxed">
              Getting started is a breeze with Appointments Pro. It automatically imports your repair categories, brands, models, and issues, along with their prices, precisely as configured in your AA Repairdesk account. This allows you to get started with Appointments Pro RIGHT AWAY!
            </p>
          </div>
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h2 className="font-dm-serif text-3xl md:text-4xl text-rd-dark mb-5">
                Seamless Integration with AA Repairdesk
              </h2>
              <p className="font-dm-sans text-gray-600 text-lg leading-relaxed">
                Turn Leads into Action with Ease! Appointments Pro syncs the lead information with AA Repairdesk, allowing you to take instant action directly from AA Repairdesk. Whether it&rsquo;s converting a lead into a ticket or sending a quick message, &ndash; It&rsquo;s just a click away!
              </p>
            </div>
