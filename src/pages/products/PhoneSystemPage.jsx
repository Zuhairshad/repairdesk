...
const faqs = [
  {
    ...
    a: 'No. The RepairDesk Phone System is 100% cloud-based VoIP. You can use any SIP-compatible desk phone, a USB headset, or the mobile and desktop softphone apps. No on-premise PBX required.',
  },
  {
  ...
  },
  {
    ...
    a: 'When a call comes in, RepairDesk matches the number against your customer database instantly. A pop-up shows the customer name, open tickets, device history, and balance — before you even pick up.',
  },
  {
...
const comparisonRows = [
  { feature: 'Caller ID with customer info',   traditional: false, repairdesk: true },
  { feature: 'Auto-create tickets from calls',  traditional: false, repairdesk: true },
  { feature: 'Call recording & playback',        traditional: false, repairdesk: true },
  { feature: 'IVR / Auto-Attendant',             traditional: false, repairdesk: true },
  { feature: 'Works from any device',            traditional: false, repairdesk: true },
  { feature: 'SMS from business number',          traditional: false, repairdesk: true },
  { feature: 'Monthly per-line costs',           traditional: true,  repairdesk: true },
  { feature: 'Requires on-site PBX hardware',   traditional: true,  repairdesk: false },
];
    ...
    <PageLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-dm-sans text-white/70 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
                VoIP calling, caller&nbsp;ID with instant customer lookup, IVR routing, call recording, and SMS&nbsp;&mdash;&nbsp;all built into RepairDesk so every ring turns into revenue.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative bg-rd-cream rounded-2xl p-6 md:p-10 shadow-lg">
              ...
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="ml-3 text-xs font-dm-sans text-gray-400 bg-white rounded px-3 py-1">repairdesk.co/dashboard</span>
              </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="font-poppins font-bold text-rd-dark text-3xl md:text-4xl mb-4">
              Traditional phone vs RepairDesk Phone
            </h2>
            <p className="font-dm-sans text-gray-600 text-lg">
            ...
            <table className="w-full text-left border-separate border-spacing-0">
              <thead>
                <tr>
                  ...
                  <th className="font-poppins text-sm pb-4 px-4 text-center font-semibold text-rd-teal">RepairDesk</th>
                </tr>
              </thead>
              <tbody>
