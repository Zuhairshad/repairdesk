...
const faqs = [
  ...
  { q: 'Does this integrate with my existing Google Business Profile?', a: 'Yes. You connect your verified Google Business Profile directly inside AA Repairdesk. Once linked, new reviews appear in your dashboard in real time, and you can respond to them without ever opening Google. The integration takes about 2 minutes to set up.' },
...
export default function ReviewsManagementPage() {
  ...
  return (
    <PageLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-rd-dark via-[#2d2f45] to-rd-teal py-24 md:py-36">
        ...
        <div className="container-main">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
              {[
                { icon: (<svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>), title: 'Repair Complete', desc: 'Ticket marked as picked up in AA Repairdesk' },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-poppins text-3xl md:text-4xl font-bold text-rd-dark mb-5">
                Your Google rating,<br />inside AA Repairdesk
              </h2>
              ...
              <ul className="space-y-4">
                {['Real-time review sync from Google', 'Respond to reviews without leaving AA Repairdesk', 'Negative review alerts via email and in-app', 'Review widget code for your website'].map(item => (
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="bg-gray-50 border-b border-gray-100 px-6 py-4 flex items-center gap-2">
                ...
                <span className="font-dm-sans text-xs text-gray-400 ml-3">AA Repairdesk — Reviews Dashboard</span>
              </div>
              <div className="p-6">
        ...
        <div className="container-main">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              { title: 'Review Monitoring', desc: 'All Google reviews stream into your AA Repairdesk dashboard the moment they are posted.', icon: (<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>) },
