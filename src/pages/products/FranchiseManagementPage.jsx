...
const faqs = [
  {
    q: 'How many franchise locations can AA Repairdesk support?',
    a: 'AA Repairdesk scales to 100+ franchise locations under a single franchisor account. Each location gets its own workspace while corporate maintains full oversight. For networks exceeding 100 locations, our enterprise team provides dedicated infrastructure.',
  },
  {
        ...
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="font-dm-sans text-gray-600 text-lg">
              From your first franchise location to your hundredth, AA Repairdesk scales with you at every milestone.
            </p>
          </div>
        ...
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="font-dm-sans text-white/60 text-lg">
              Define your royalty structure once. AA Repairdesk calculates, invoices, and reports — every billing cycle, hands-free.
            </p>
          </div>
