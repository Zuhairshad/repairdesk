...
const posts = [
  ...
  { cat: 'Product Updates', catColor: 'bg-rd-teal/5 text-rd-teal', title: 'Introducing AA Repairdesk ARIA: Your AI-Powered Repair Assistant', excerpt: 'ARIA uses machine learning to suggest repair times, flag anomalies in tickets, and auto-categorise devices.', date: 'Jan 7, 2025', readTime: '4 min' },
  { cat: 'How-To Guides', catColor: 'bg-amber-100 text-amber-700', title: 'Setting Up Your First Loyalty Program in AA Repairdesk', excerpt: 'A step-by-step walkthrough from creating tiers to automating point redemptions at checkout.', date: 'Dec 30, 2024', readTime: '7 min' },
  { cat: 'Customer Stories', catColor: 'bg-purple-100 text-purple-700', title: 'How iFixScreens Scaled to 50+ Locations with AA Repairdesk', excerpt: '"AA Repairdesk gave us the infrastructure to franchise confidently." Their journey from one store to a national brand.', date: 'Dec 22, 2024', readTime: '6 min' },
  ...
  { cat: 'Industry Tips', catColor: 'bg-blue-100 text-blue-700', title: 'The Repair Shop Inventory Mistakes Costing You Thousands', excerpt: 'Overstocking slow-movers, under-ordering hot parts, no barcode system -- and how AA Repairdesk fixes all three.', date: 'Dec 12, 2024', readTime: '5 min' },
  { cat: 'How-To Guides', catColor: 'bg-amber-100 text-amber-700', title: 'Migrating from RepairShopr to AA Repairdesk: A Smooth Playbook', excerpt: 'Data export, import, staff training, and going live -- everything you need to switch with zero downtime.', date: 'Dec 5, 2024', readTime: '11 min' },
      ...
      <section className="bg-rd-dark py-20 px-6">
        <div className="container-main max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 bg-rd-teal/20 border border-rd-teal/40 rounded-full px-4 py-1.5 mb-6">
            <span className="text-rd-teal font-poppins font-semibold text-xs tracking-wider uppercase">AA Repairdesk Blog</span>
          </div>
