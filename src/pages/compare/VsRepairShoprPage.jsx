...
const advantages = [
  { num: '01', title: 'All-in-One Marketing Suite', desc: 'AA Repairdesk includes email campaigns, SMS marketing, loyalty programs, and review collection — tools RepairShopr charges extra for or lacks entirely.' },
  { num: '02', title: 'Built-in Phone System', desc: 'Take calls, see caller ID linked to customer profiles, record calls, and route voicemails — all from within AA Repairdesk. RepairShopr has no native phone system.' },
  ...
  { num: '04', title: 'Google Reviews Automation', desc: "Automatically request reviews after every completed repair. AA Repairdesk's integration sends requests at the right moment to maximise 5-star ratings." },
...
export default function VsRepairShoprPage() {
  ...
  return (
    <PageLayout>
        ...
        <div className="container-main max-w-5xl relative z-10 text-center">
          ...
          <div className="flex items-center justify-center gap-8 mb-8">
            <div className="text-center">
              ...
              <p className="font-poppins font-bold text-white text-lg">AA Repairdesk</p>
            </div>
          ...
          <h1 className="font-poppins font-bold text-3xl md:text-4xl text-white mb-4 leading-tight">
            AA Repairdesk vs RepairShopr:<br />Which Repair Shop Software Is Better?
          </h1>
          ...
          <Link to="/register" className="inline-flex items-center gap-2 bg-rd-teal text-white font-poppins font-semibold px-8 py-3.5 rounded-xl hover:bg-rd-dark-teal transition-colors">
            Try AA Repairdesk Free for 14 Days
          </Link>
        </div>
      </section>
              ...
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="px-6 py-4 text-center w-1/4">
                    <span className="font-poppins font-bold text-rd-teal text-sm">AA Repairdesk</span>
                  </th>
                  <th className="px-6 py-4 text-center w-1/4">
      ...
      {/* Why AA Repairdesk Wins */}
      <section className="py-20 px-6 bg-white">
        <div className="container-main max-w-5xl">
          <div className="text-center mb-14">
            <h2 className="font-poppins font-bold text-3xl text-rd-dark mb-2">Why Repair Shops Choose AA Repairdesk Over RepairShopr</h2>
              ...
              <div key={i} className="bg-white/10 border border-white/20 rounded-2xl p-6 text-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-dm-sans text-white/50 text-xs">AA Repairdesk</p>
