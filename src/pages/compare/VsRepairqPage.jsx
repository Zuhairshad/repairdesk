...
const differentiators = [
  {
    ...
    description:
      'Repairq covers ticket tracking and basic inventory, but AA Repairdesk goes further with multi-location management, franchise tools, and centralized reporting. Whether you run one store or twenty, AA Repairdesk grows with you instead of holding you back.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Gift cards, loyalty programs, store credits, and built-in marketing automation turn one-time customers into repeat visitors. AA Repairdesk includes all of these out of the box. With Repairq, you either go without or patch together outside services.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const faqs = [
  {
    q: 'Can I switch from Repairq to AA Repairdesk easily?',
    a: 'Yes. AA Repairdesk provides a free assisted migration that transfers your customers, repair tickets, inventory, and invoices. Our onboarding team walks you through every step so the transition is smooth and nothing gets lost.',
  },
  {
    q: 'How does AA Repairdesk pricing compare to Repairq?',
    a: 'AA Repairdesk plans start at $99/month and include features that Repairq either does not offer or charges extra for — such as marketing automation, loyalty programs, gift cards, and multi-location management. You get more value without bolting on third-party tools.',
  },
  {
    q: 'Does AA Repairdesk support multi-store and franchise operations?',
    a: 'Yes. AA Repairdesk includes centralized inventory, cross-store reporting, franchise management dashboards, and role-based permissions designed for businesses with multiple locations. Repairq is limited to single-store workflows.',
  },
  {
    q: 'Does AA Repairdesk offer a free trial?',
    a: 'Yes. You can start a 14-day free trial with full access to every feature — no credit card required. That gives you time to import your data and compare AA Repairdesk to Repairq in your actual workflow.',
  },
  {
    q: 'What integrations does AA Repairdesk support?',
    a: 'AA Repairdesk integrates with QuickBooks, Xero, Shopify, WooCommerce, eBay, and dozens of other platforms. It also offers AA Repairdesk Connect for custom integrations and an open API for developers who need deeper connectivity.',
  },
];
    ...
    <PageLayout>
      ...
      <section className="bg-gradient-to-br from-rd-dark via-[#2d2f45] to-rd-teal text-white py-24 md:py-32 px-6">
        <div className="container-main max-w-4xl text-center">
          ...
          <h1 className="font-poppins font-bold text-4xl md:text-5xl lg:text-[56px] leading-tight mb-6">
            AA Repairdesk vs Repairq — The Upgrade Your Repair Shop Deserves
          </h1>
          <p className="text-white/80 text-lg md:text-xl font-dm-sans leading-relaxed max-w-2xl mx-auto mb-10">
            Repairq handles the basics, but AA Repairdesk delivers a complete platform — from multi-location management and marketing automation to in-store hardware that transforms the customer experience.
          </p>
      ...
      <section className="bg-white py-16 md:py-24 px-6">
        <div className="container-main max-w-4xl">
          ...
          <p className="text-gray-500 font-dm-sans text-center mb-12 max-w-xl mx-auto">
            See how AA Repairdesk stacks up against Repairq across the features repair shops rely on every day.
          </p>
      ...
      <section className="bg-rd-cream py-16 md:py-24 px-6">
        <div className="container-main max-w-5xl">
          <h2 className="font-poppins font-semibold text-3xl md:text-4xl text-rd-dark text-center mb-4">
            Why Repair Shops Choose AA Repairdesk Over Repairq
          </h2>
          <p className="text-gray-500 font-dm-sans text-center mb-12 max-w-xl mx-auto">
            Three areas where AA Repairdesk delivers what Repairq cannot.
          </p>
