...
const faqs = [
  ...
  {
    q: 'How much does a AA Repairdesk subscription cost?',
  ...
  },
  {
    ...
    a: 'Core integrations like QuickBooks Online, Xero, and Zapier are available starting on the Essential plan. Payment integrations such as AA Repairdesk Payments, Square, Stripe, and PayPal, along with M360 Diagnostics, Shopify, and WooCommerce, are available across plans — reach out to our team to confirm availability for your specific setup.',
  },
  {
      ...
      <section className="bg-rd-dark py-20">
        <div className="container-main text-center">
          ...
          <p className="font-dm-sans text-gray-300 text-lg max-w-xl mx-auto mb-8">
            Join thousands of repair shops worldwide who trust AA Repairdesk to run their business
            every day.
          </p>
