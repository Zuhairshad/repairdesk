...
const quickStartSteps = [
  { step: 1, title: 'Create Your Account', desc: 'Sign up and verify your email to access your RepairDesk dashboard.', time: '2 min' },
...
const videoTutorials = [
  { title: 'RepairDesk Full Walkthrough', duration: '12:34', views: '24K', thumb: 'rd-teal' },
        ...
        <div className="container-main">
          <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
            <div>
              ...
              <p className="text-gray-500 font-dm-sans mt-1">9 categories covering every corner of RepairDesk.</p>
            </div>
      ...
      <section className="bg-rd-dark py-16 md:py-20 px-6 relative overflow-hidden">
        ...
        <div className="container-main relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-4xl mx-auto">
            {/* Email */}
            <a href="mailto:hello@repairdesk.co" className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-rd-teal/40 rounded-2xl p-6 text-center transition-all">
