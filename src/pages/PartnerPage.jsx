...
const resellerBenefits = [
  {
    ...
    desc: 'Get a signup bonus and recurring commission for every customer you refer to AA Repairdesk.',
    icon: (
...
const orderSyncBenefits = [
  ...
  },
  {
    ...
    desc: 'Delight your customers with a smooth ordering experience with AA Repairdesk.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const highlights = [
  {
    ...
    desc: "AA Repairdesk's partnership with Techy is focused towards developing AA Repairdesk University to help repair store owners excel in their business.",
  },
  {
    tag: 'Supplier Integration',
    title: 'AA Repairdesk Integration with MobileSentrix Canada is now LIVE!',
        ...
        <div className="container-main relative z-10 grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-14 items-center">
          ...
          <div className="relative mx-auto w-full max-w-md aspect-square">
            <svg viewBox="0 0 400 400" className="w-full h-full">
              ...
              <text x="200" y="196" textAnchor="middle" fill="#FFFFFF" fontSize="15" fontWeight="700" fontFamily="Poppins, sans-serif">AA Repairdesk</text>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-4 mt-9">
                ...
                <div className="text-left">
                  ...
                  <div className="font-dm-sans text-white/60 text-sm">CEO &amp; Founder, AA Repairdesk</div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 items-center">
            <div>
              ...
              <p className="font-dm-sans text-gray-600 leading-relaxed mb-8">
                Do you like sharing things you love? Help your fellow repair businesses upgrade to AA Repairdesk and earn money while opening new possibilities for them.
              </p>
        ...
        <div className="container-main relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="font-dm-sans text-white/70 leading-relaxed">
              Become your customer's favorite supplier by helping them save up to 20 hrs in inventory management. With AA Repairdesk's OrderSync application integration, customers can import Purchase Order details in just one click, update cost and pricing in their POS, and automatically save SKUs — reducing manual hassle and improving efficiency in their repair shops.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <ul className="space-y-4 font-dm-sans text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <a href="mailto:partnerships@aarepairdesk.co" className="text-rd-dark hover:text-rd-teal">partnerships@aarepairdesk.co</a>
                </li>
                <li className="flex items-start gap-3">
