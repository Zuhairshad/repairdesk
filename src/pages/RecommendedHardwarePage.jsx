...
/* ---------------------------------------------------------------------- */
/* Catalog data — exact copy from repairdesk.co/recommended-hardware       */
/* ---------------------------------------------------------------------- */
      ...
      <section className="bg-white py-14 px-6">
        <div className="container-main">
          <div className="rounded-2xl bg-rd-dark px-8 py-10 md:px-12 md:py-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <a href="https://app.repairdesk.co/register" className="btn-primary px-8 py-3.5 whitespace-nowrap">
              Free Trial
            </a>
          </div>
        </div>
