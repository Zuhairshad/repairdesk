...
const ticketFeatures = [
  ...
  },
  {
    ...
    to: '/features/aarepairdesk-payments',
...
const integrations = [
  ...
  },
  {
    ...
    desc: 'Be confident, every transaction in AA Repairdesk is reflected in your Integrated Xero account.',
    to: '/integrations',
...
const faqs = [
  {
    ...
    a: (
      <>
        The best way to advertise your store is by creating optimized blogs that highlight your store and promoting your work, customer testimonials, and feedback on social media. With the AA Repairdesk{' '}
  ...
  },
  {
    ...
    a: 'Yes. You can. With AA Repairdesk, you can store supplier details, manage purchase orders, track shipments, and even generate Goods Received Notes (GRN). It allows seamless integration, so your vendor communication will always stay organized.',
  },
  {
    q: 'Do I manage the warranty of watches separately in my watch repair store?',
    a: (
      <>
        No, not at all. AA Repairdesk allows you to enter warranty information for all services and parts. You can easily define the claim, history, duration, and conditions within{' '}
  ...
  {
    q: "How can my watch shop's workflow improve using AA Repairdesk?",
    a: 'Through using the watch repair shop workflow management, AA Repairdesk simplifies your workflow by managing every aspect, starting from repair ticket management, inventory, billing, payments, reports, and so much more. Everything is digitalized and centralized for easy use.',
  },
];
        ...
        <div className="container-main grid lg:grid-cols-[1fr_1.2fr] gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-500 font-dm-sans text-lg leading-relaxed">
              Start offering your customers with <span className="font-semibold text-rd-dark">mail-in repair</span> facility through an integrated calendar on your website. The appointments land in AA Repairdesk allowing you to create a ticket against it, send repair job notifications to the customer, and email the invoice with a pay link.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-rd-dark py-16 md:py-20 px-6">
        <div className="container-main">
          ...
          <h2 className="font-poppins font-bold text-3xl md:text-4xl text-white mb-4 max-w-2xl">
            AA Repairdesk Works Better Together
          </h2>
          <p className="text-white/70 font-dm-sans text-lg mb-12 max-w-2xl">
            Connect all your core systems with the central headquarters of your business that is AA Repairdesk for seamlessly managing everything from one place.
          </p>
      ...
      <section className="bg-[#1e2035] py-16 md:py-20 px-6">
        <div className="container-main text-center">
          ...
          <p className="text-white/70 font-dm-sans text-lg max-w-2xl mx-auto mb-12">
            When you join AA Repairdesk, you don't just get a software. You join a community of watch repair shop owners around the world who help you learn and grow your business.
          </p>
