...
/* ---- FAQ data ---- */
const faqs = [
  { q: 'How does the online repair request form work?', a: 'You embed a booking widget on your website. Customers fill in their device details, select the repair type, and submit. AA Repairdesk automatically creates a repair ticket, sends a confirmation email with a pre-paid shipping label, and assigns the job to a technician queue.' },
  { q: 'Which shipping carriers does AA Repairdesk integrate with?', a: 'AA Repairdesk integrates with ShipStation, which connects you to FedEx, UPS, USPS, DHL, and dozens of other carriers. You can generate labels, compare rates, and track shipments from inside AA Repairdesk without switching between apps.' },
  ...
  { q: 'How does damage documentation protect my business?', a: 'When a device arrives, technicians photograph the device and log its condition using AA Repairdesk intake forms. These timestamped records are attached to the repair ticket and visible in the customer portal, preventing disputes about pre-existing damage.' },
  { q: 'Do I need a separate ShipStation subscription?', a: 'Yes, ShipStation requires its own subscription. AA Repairdesk connects to your ShipStation account via API to pull rates, generate labels, and sync tracking numbers. The integration eliminates double-entry and keeps shipping data inside your repair workflow.' },
];
    ...
    <PageLayout>
      ...
      <section className="relative bg-gradient-to-br from-rd-dark via-[#2d2f45] to-rd-teal text-white py-28 px-6 overflow-hidden">
        ...
        <div className="container-main max-w-3xl relative z-10">
          ...
          <p className="text-white/75 text-lg md:text-xl font-dm-sans leading-relaxed mb-10 max-w-2xl">
            Accept devices from anywhere in the country. AA Repairdesk handles the entire mail-in cycle — online requests, shipping labels, package tracking, automated updates, and return delivery — so your customers always know exactly where their device is.
          </p>
      ...
      <section className="bg-rd-cream py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-500 font-dm-sans text-center max-w-xl mx-auto mb-14">Every mail-in repair follows six clear stages. AA Repairdesk automates each handoff so nothing falls through the cracks.</p>
        ...
        <div className="container-main">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 font-dm-sans text-lg leading-relaxed mb-6">Embed a branded booking form on your website. Customers describe the issue, upload photos, and submit — AA Repairdesk creates the ticket, emails a shipping label, and queues the job before you even open for the day.</p>
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main text-center">
          ...
          <p className="text-gray-500 font-dm-sans text-lg max-w-2xl mx-auto mb-12">AA Repairdesk connects to ShipStation so you can compare rates, print labels, and track packages across all carriers — without leaving your repair dashboard.</p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { icon: <IconPackage className="w-6 h-6" />, title: 'Generate Labels', desc: 'Create outbound and return shipping labels from inside AA Repairdesk. Costs are logged against the repair ticket.' },
              ...
              { icon: <IconShield className="w-6 h-6" />, title: 'Sync Tracking', desc: 'Tracking numbers flow back into AA Repairdesk automatically. Customers get SMS/email updates at every scan.' },
            ].map(feat => (
        ...
        <div className="container-main">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-500 font-dm-sans text-lg leading-relaxed mb-6">The number-one complaint in mail-in repair is silence. AA Repairdesk sends automated SMS and email notifications at each stage transition — so your customer never has to wonder what is happening.</p>
        ...
        <div className="container-main max-w-4xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/65 font-dm-sans text-lg leading-relaxed mb-6">When a device arrives by mail, there is no face-to-face handoff. AA Repairdesk intake forms let technicians photograph every angle and log pre-existing damage before work begins. Every record is timestamped and attached to the ticket.</p>
