...
const howItWorks = [
  ...
  },
  {
    ...
    desc: 'Streamline transactions through integrated payment processing with Square and RepairDesk Payments. Search for items, tickets, invoices, or customer details for a smooth workflow.',
  },
  {
    icon: IconBox,
...
const customizationCards = [
  ...
  },
  {
    icon: IconCheckIn,
    title: 'Self Check-in',
    desc: "Eliminate manual check-ins and provide convenience to your customers with RepairDesk's self-check-in feature.",
  },
  {
    icon: IconPhone,
    title: 'Phone System',
...
const customFieldPerks = [
  ...
  "Cut exciting deals with RepairDesk's trade-in module",
          ...
          <div className="bg-[#0C3C3E] rounded-3xl p-8 md:p-14 grid grid-cols-1 md:grid-cols-[0.4fr_0.6fr] gap-10 items-center relative overflow-hidden">
            ...
            <div>
              ...
              <h2 className="font-poppins font-bold text-2xl md:text-3xl text-white mb-4">
                Team Newland Ag Drones about RepairDesk
              </h2>
            ...
            <div className="bg-white rounded-2xl p-7 md:p-9 relative z-10">
              ...
              <p className="text-rd-dark font-dm-sans italic leading-relaxed mb-6">
                Once we had everything in RepairDesk, we stopped guessing where a repair stood and started running service with a lot more clarity. RepairDesk gave us a more dependable way to stay organized as volume increased because we can see the repair and the status in one place.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.45fr_0.55fr] gap-14 items-start mb-14">
            <div>
              ...
              <h2 className="font-poppins font-bold text-3xl md:text-4xl text-rd-dark mb-5">
                Customize RepairDesk for Your Drone Repair Store
              </h2>
              <p className="text-gray-500 font-dm-sans text-lg leading-relaxed">
                Leverage high-level customization to create your check-in flow and serve your customers in the best way possible. Provide value to your customers by utilizing RepairDesk&rsquo;s trade-in module to cut exciting deals.
              </p>
            </div>
          ...
          <div className="bg-[#0C3C3E] rounded-3xl p-8 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="font-poppins font-bold text-2xl md:text-3xl text-white mb-5 max-w-xl mx-auto">
                When you join RepairDesk, you don&rsquo;t just get a software
              </h2>
