...
const mailInSteps = [
  ...
  },
  {
    ...
    desc: "Provide customers with peace of mind by embedding the RepairDesk Repair Tracker on your website. Customers can enter their ticket ID and last name to check the status of their shoes, bags, or leather items online.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const paymentCards = [
  ...
  },
  {
    ...
    desc: "Connect with popular providers like Square, Stripe, Paypal, RepairDesk Payments. Choose what fits your workflow.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    badges: ["Square", "Stripe", "Paypal", "RepairDesk Payments"],
  },
  {
    title: "PCI-Compliant",
...
const faqs = [
  {
    q: "Does RepairDesk also Manage Mail-in Shoe Repairs?",
    a: "Yes. RepairDesk can manage both physical storefronts and mail-in repair service providers. One can easily manage online inquiries, shipping, and tracking.",
  },
  {
    q: "Which One is the Best Shoe Repair Shop Software and Why?",
    a: "RepairDesk is by far, the best shoe repair shop software you can find today. It offers all the inventory, mail-in repair, repair ticket, and employee management features.",
  },
  {
  ...
  {
    q: "Can I Manage Leather Goods and Bags Repair Jobs with RepairDesk?",
    a: "Yes. You can manage leather goods, shoes, and bags repair jobs as RepairDesk offers all shoe repair store management features. You can manage restoration, polishing, and patchwork, etc., for all types of bags, shoes and leather goods.",
  },
  {
    q: "What Payment Integrations Does RepairDesk Offer?",
    a: "RepairDesk allows you to connect with Square, Stripe, PayPal and RepairDesk Payments effortlessly. So, you can choose what fits your workflow.",
  },
  {
    q: "Can Shoe Repair Software Manage Walking Aids Repairs?",
    a: "Yes. You can manage walking aids with RepairDesk. It tracks, organizes and maintains walking aids such as shoe tips, and orthopedic supports.",
  },
  {
    q: "Is RepairDesk also Suitable for Small Shoe Repair Shops?",
  ...
  {
    q: "How Does RepairDesk Help You Manage Shoe Repair Parts?",
  ...
  {
    q: "Can RepairDesk Manage Different Footwear Repair Types?",
    a: "Yes. Using RepairDesk, you can manage various footwear repair services including leather boots, sneakers, and sandals repair. Along with that, you can also manage custom shoe restoration jobs.",
  },
];
        ...
        <div className="container-main grid md:grid-cols-[1.15fr_0.85fr] gap-14 items-center relative z-10">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="https://app.repairdesk.co/register" className="border border-white/30 text-white px-8 py-3.5 rounded-full font-poppins font-semibold hover:bg-white/10 transition-colors">Free Trial</a>
            </div>
          </div>
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-poppins font-bold text-3xl md:text-4xl text-rd-dark mt-3 mb-5">Mail‑In Repairs Made Simple with RepairDesk</h2>
            <p className="text-gray-600 font-dm-sans leading-relaxed mb-3">
              Embed a branded request form on your website so customers can quickly take a picture of their shoes, bags, or leather items and send it for assessment. All these requests automatically flow into RepairDesk, keeping every detail, from images to service notes, organized in one place.
            </p>
            <p className="text-gray-600 font-dm-sans leading-relaxed mb-3">
      ...
      <section className="bg-white py-16 px-6 border-y border-gray-100">
        <div className="container-main text-center">
          ...
          <p className="text-gray-500 font-dm-sans max-w-2xl mx-auto mb-10">
            Thousands of business owners and cobblers around the world trust RepairDesk to run their shoe repair shops smarter and support each other.
          </p>
