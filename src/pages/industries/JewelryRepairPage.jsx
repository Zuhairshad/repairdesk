...
/* ---------- content data (verbatim from repairdesk.co) ---------- */
...
const painPoints = [
  ...
  },
  {
    ...
    desc: "Use the software to suit your shop's operations by integrating it with WooCommerce, RepairDesk payments, and SMS integration. Keep your transactions updated, get paid faster, and connect with the customers.",
  },
  {
    icon: IconBox,
...
const integrations = [
  ...
  },
  {
    ...
    desc: "Think of a personal assistant diligently reflecting all your transactions in your integrated Xero account. That's RepairDesk!",
  },
  {
    icon: IconSMS,
...
const faqs = [
  ...
  {
    q: 'Can you track jewelry repair jobs with RepairDesk?',
    a: "Yes, you can. RepairDesk's jewelry repair tracking software creates digital tickets for every repair job. To determine the status of a specific repair, all you need to do is type the customer name or ticket ID in the Jewelry shop POS system.",
  },
  {
    q: 'Can I use the same system for repair services and jewelry sales?',
    a: 'You absolutely can. RepairDesk combines jewelry repair store management and sales under one roof. You can sell jewelry, create tickets, track inventory, and track all progress from the same POS dashboard.',
  },
  {
    q: 'Can I set custom prices for jewelry repair and service using RepairDesk?',
    a: 'Yes. RepairDesk lets you set and adjust custom prices for every repair job and service item, so pricing always reflects the materials, labor, and complexity of the piece in front of you.',
  },
];
    ...
    <PageLayout>
      ...
      <section className="relative bg-rd-dark text-white overflow-hidden">
        ...
        <div className="container-main relative z-10 py-24 px-6 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="https://app.repairdesk.co/register" className="btn-primary px-8 py-3.5">
              Start My Free Trial
            </a>
            <Link
              to="/contact"
      ...
      <section className="bg-white py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-500 font-dm-sans text-lg mb-14 max-w-2xl">
            Save three hours every day to focus on your business growth while RepairDesk automatically handles all the legwork for you.
          </p>
      ...
      <section className="bg-rd-cream py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-500 font-dm-sans text-lg mb-14 max-w-2xl">
            Make RepairDesk handle the repair ticket workflow separately for each item like jewelry, watch, and keychain. You can easily adjust the system to suit your shop operations – the way you need it.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/70 font-dm-sans text-lg leading-relaxed">
                RepairDesk supports "Rat Tail" and "Barbell" label templates, designed especially for delicate and small jewelry items. These tags ensure professional presentation and secure tagging. You can customize size, print layout, and even include logos or repair codes.
              </p>
            </div>
      ...
      <section className="bg-[#FAF9E3] py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-600 font-dm-sans text-lg mb-14 max-w-2xl">
            RepairDesk isn't just built for helping you repair precious family heirlooms – it also lets you forge customer relationships as precious as any treasure you're tasked with fixing.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="bg-[#0C3C3E] py-16 px-6 text-white">
        <div className="container-main text-center">
          ...
          <p className="text-white/70 font-dm-sans max-w-2xl mx-auto mb-12">
            When you join RepairDesk, you don't just get a software. You join a community of jewelry repair shop owners around the world who help you learn and grow your business.
          </p>
