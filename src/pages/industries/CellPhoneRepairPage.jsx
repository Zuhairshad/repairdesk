...
/* ---------------------------------------------------------------- */
/* Content pulled directly from the aarepairdesk.co cell phone page   */
/* ---------------------------------------------------------------- */
...
const coreFeatures = [
  ...
  },
  {
    ...
    tags: ['Appointment Pro online booking', 'Email and SMS alerts', 'AA Repairdesk Forms', 'Mail-in repair suite', 'Lead-to-ticket flow'],
  },
  {
    icon: 'chat',
    accent: 'lime',
    ...
    tags: ['AA Repairdesk Connect inbox', 'Two-way SMS', 'Google My Business integration', 'Facebook Messenger integration'],
  },
];
...
const testimonials = [
  {
    quote:
      'Our experience with AA Repairdesk has been a really exciting advancement for our business. While there was a transition period moving to the new system, the positive and cooperative attitude of the company is one that we really admire. Usman and his team go out of their way to assist their customers and are open to feedback and integrating new ideas into their software, as well as providing an extensive knowledge base and tailored support for your business model. Cannot recommend these guys enough for all the hard work and grit they pour into their software.',
    name: 'Simon Nash',
    title: 'Owner, The iPhone Guy',
  },
  {
    quote:
      'We had good experience working with the team at AA Repairdesk in switching everything over from Quickbooks. This software is what I always dreamed of creating for my business. Thank you for all your help and continued improvements with AA Repairdesk!',
    name: 'Lyle Schrock',
    title: 'Owner, The Lab',
  },
];
      ...
      <section className="bg-white pt-16 md:pt-20 pb-14 px-6">
        <div className="container-main text-center">
          ...
          <h2 className="font-poppins font-semibold text-2xl md:text-3xl text-rd-dark mb-10">
            3000+ Repair Stores Run on AA Repairdesk
          </h2>
          ...
          <div>
            ...
            <div className="bg-white/10 border border-white/10 rounded-2xl p-6 md:p-7">
              <p className="text-white font-dm-sans text-base md:text-lg leading-relaxed">
                ...
                <span className="text-rd-mint font-semibold">AA Repairdesk keeps repairs, inventory, and checkout connected</span>, so your shop stays in control.
              </p>
            </div>
          </div>
        ...
        <div className="container-main">
          <div className="max-w-3xl mb-14">
            ...
            <p className="text-gray-500 font-dm-sans text-lg leading-relaxed">
              From cracked screens and battery swaps to charge port fixes and diagnostics, the work moves fast on a busy bench. AA Repairdesk keeps the full job in one place, from intake to pickup, with tickets, inventory, customer updates, and checkout working together.
            </p>
          </div>
      ...
      <section className="bg-rd-cream py-20 md:py-24 px-6">
        <div className="container-main">
          <div className="max-w-3xl mb-14">
            ...
            <p className="text-gray-500 font-dm-sans text-lg leading-relaxed">
              Phone repair is detailed work. Your software should keep up. These are the core tools AA Repairdesk brings together so that tickets, parts, customers, and checkout stay connected during the daily rush.
            </p>
          </div>
        ...
        <div className="container-main">
          <div className="text-center mb-12">
            ...
            <h2 className="font-poppins font-bold text-3xl md:text-4xl text-white max-w-2xl mx-auto">
              Shops Trust AA Repairdesk to Keep Every Repair Moving
            </h2>
          </div>
        ...
        <div className="container-main flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          <div>
            ...
            <p className="text-rd-dark/70 font-dm-sans text-base">
              Join thousands of repair stores running faster tickets, checkout, and inventory on AA Repairdesk.
            </p>
          </div>
