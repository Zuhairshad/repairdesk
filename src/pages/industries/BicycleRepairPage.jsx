...
const faqs = [
  {
    ...
    a: 'As a bicycle repair store owner, you have multiple options. However, RepairDesk stands among all of them. It helps you schedule services, assign repairs to technicians, and track progress all from one place.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. A bicycle repair shop POS software like RepairDesk integrates with Shopify and WooCommerce, letting you sell bicycles and accessories online, and keeps your inventory and customer data synced.',
  },
  {
    q: 'What Bicycle Repair Shop Billing Software or Methods Can Help with Invoices and Repairs?',
    a: 'For a bicycle shop, a good POS system for repair shop should handle both invoicing and repairs. Among all the software available right now, RepairDesk is one that checks all those boxes. It offers repair job management (tickets, assigning techs, notes), and invoices (digital invoices, payment links).',
  },
  {
    q: 'How can I Get Good Reviews for My Bicycle Repair Shop?',
    a: 'First, you need to offer great repair services and customer support. Secondly, you can get help from the RepairDesk Google reviews automation tool. It helps you send a review link to your customers 24 hours after the repair is done. Thus, you can get more 5-star reviews and rank your store even better.',
  },
  {
    q: 'How Much Do I Have to Spend to Get Reliable Management Software for My Bicycle Shop?',
    a: "The cost of a bicycle repair shop software depends on your store's size and the features you need. When it comes to reliability and ease of use, there is nothing better than RepairDesk, and you can get the subscription for $99/store per month. And if you go for the annual plan, you can get it for as low as $79.",
  },
  {
    q: 'Does RepairDesk also Offer Customer Support?',
    a: 'Yes, we are available 24 hours, 6 days a week to serve you. You can connect with one of our product specialists or send us an email at support@repairdesk.co, anytime you want.',
  },
];
      ...
      <section className="bg-rd-dark text-white pt-20 pb-28 px-6 relative overflow-hidden">
        ...
        <div className="container-main relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="https://app.repairdesk.co/register" className="border border-white/40 text-white px-8 py-3.5 rounded-full font-poppins font-semibold hover:bg-white/10 transition-colors">Free Trial</a>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.55fr_0.45fr] gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 font-dm-sans text-lg leading-relaxed mb-4">
                Say goodbye to juggling between paper-based service request forms or using multiple systems that don't integrate. With RepairDesk, all-in-one bicycle repair shop ticketing system, you can quickly access all job-related data to view job status, due dates, and overdue tasks in one place at a glance.
              </p>
      ...
      <section className="bg-white py-16 md:py-24 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-600 font-dm-sans text-lg leading-relaxed mb-10 max-w-2xl">
            From bicycles to kickstands and helmets, RepairDesk allows you to effectively manage your inventory, ensuring you are always aware of what you have in stock and will need before demand arises.
          </p>
      ...
      <section className="bg-rd-cream py-16 md:py-24 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-600 font-dm-sans text-lg leading-relaxed mb-12 max-w-2xl">
            RepairDesk provides a unified platform with Payments seamlessly integrated into your bicycle shop POS. This automates your payment process, reducing errors and quicker checkouts without manual entries. With RepairDesk Integrated payment processing, you get:
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="rounded-3xl bg-[#1e2035] p-8 md:p-14 grid grid-cols-1 lg:grid-cols-[0.6fr_0.4fr] gap-10 items-center">
            <div>
              ...
              <p className="text-white/70 font-dm-sans leading-relaxed">
                When you join RepairDesk, you don't just get a software. You join a community of bicycle repair shop owners around the world who help you learn and grow your business.
              </p>
            </div>
