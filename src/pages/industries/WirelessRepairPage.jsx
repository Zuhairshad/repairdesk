...
const inventoryFeatures = [
  ...
  { icon: IconSwap, title: 'Transfer Inventory b/w Stores', desc: 'Do you own more than one wireless store? With AA Repairdesk, you can easily sync and transfer inventory across all your locations, making inventory management tasks a breeze!' },
...
const efficiencyFeatures = [
  ...
  { icon: IconStar, title: 'Loyalty Program', desc: 'Use the AA Repairdesk loyalty program to cultivate stronger relationships, grow repeat business, and increase lifetime value.', link: '/features/loyalty-program' },
    ...
    <PageLayout>
        ...
        <div className="container-main">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <p className="text-rd-dark font-poppins font-semibold max-w-xs md:text-right">
              Whether you prefer selling in-store or online, AA Repairdesk provides the tools to scale.
            </p>
          </div>
        ...
        <div className="container-main relative z-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 mb-12">
            ...
            <p className="text-white/70 font-dm-sans text-lg leading-relaxed max-w-xl">
              Top-up mobile phones of leading providers with the AA Repairdesk Bill Payments module. Accept payments for {carriers.slice(0, 3).join(', ')}, and more&mdash;ensuring you never lose a sale due to platform limitations. Expand your network carrier options and instantly recharge multiple networks in just a few clicks!
            </p>
          </div>
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-[0.5fr_0.5fr] gap-12 items-center">
            <div>
              ...
              <p className="text-white/70 font-dm-sans leading-relaxed">
                AA Repairdesk provides a unified platform with Payments seamlessly integrated into your POS. This automates your payment process, reducing errors and quicker checkouts without manual entries. With AA Repairdesk Integrated payment processing, you get:
              </p>
              <a href="https://app.aarepairdesk.co/register" className="btn-primary px-8 py-3.5 inline-block mt-8">Start Free Trial</a>
            </div>
      ...
      <section className="bg-white py-16 md:py-20 px-6">
        <div className="container-main text-center">
          ...
          <p className="text-gray-500 font-dm-sans max-w-2xl mx-auto mb-12">
            When you join AA Repairdesk, you don&rsquo;t just get software. You join a community of wireless repair shop owners around the world who help you learn and grow your business.
          </p>
      ...
      <section className="relative bg-rd-teal text-white py-16 md:py-20 px-6 overflow-hidden">
        ...
        <div className="container-main text-center relative z-10">
          ...
          <a href="https://app.aarepairdesk.co/register" className="btn-white px-10 py-3.5 inline-block">Start Free Trial</a>
        </div>
      </section>
    </PageLayout>
  );
