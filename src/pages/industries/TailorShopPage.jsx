...
const faqs = [
  ...
  { q: 'Does AA Repairdesk handle before-and-after photos?', a: 'Yes. Attach photos at intake and after completion directly from a phone or tablet camera. Photos are stored on the ticket and can be shared with the customer via email or the online repair tracker.' },
          ...
          <div className="flex flex-col lg:flex-row items-start gap-14">
            <div className="flex-1 max-w-md pt-4">
              ...
              <p className="text-gray-500 font-dm-sans text-lg leading-relaxed mb-5">
                Schedule fitting and measurement appointments directly inside AA Repairdesk. Automated SMS and email reminders go out before each appointment so your chair is never empty.
              </p>
