...
const employeeFeatures = [
  ...
  { title: 'Performance Monitoring', desc: "Get real-time insights into who's completing the most repairs, bring in sales, upselling services and more with AA Repairdesk, leading software for camera repair shops.", icon: icons.chart },
];
...
const faqs = [
  {
    ...
    a: 'Yes. You can easily track the parts from the purchase order history while using AA Repairdesk.',
  },
  {
    q: 'Can I create an estimate and provide a quote to the customer using camera repair shop software?',
    a: (
      <>
        Yes. It is possible. AA Repairdesk allows you to create an estimate beforehand and send it to your customers for approval. Moreover, our{' '}
  ...
  },
  {
    ...
    a: 'Yes, it is completely possible. When you assign a repair ticket to the technician, you can always check its status and send your technician reminders using AA Repairdesk.',
  },
  {
    q: 'How can I track shutters, lenses, and batteries in my camera repair store?',
    a: 'You can search for the parts either by SKUs in the inventory or by the product name, using the AA Repairdesk camera inventory management software.',
  },
  {
    q: 'What is the best camera repair shop management software?',
    a: 'The best camera repair shop management software is the one that automates your repair tickets, inventory, and billing, all while properly updating your customers. Not only that, but it also offers integrations so you can efficiently operate your store and design your own workflow. AA Repairdesk checks all the boxes in this case.',
  },
  {
    q: 'How can I track the sales made by employees in my camera repair store?',
    a: 'AA Repairdesk creates a specific profile for each employee, so each sale made by them during their shift hours will be tracked through their profile. You can also view their progress in the employee reports available in the reports section of AA Repairdesk.',
  },
  {
    q: 'Does AA Repairdesk support diagnostic checklists for camera repairs?',
    a: "Yes. It does. In AA Repairdesk's camera shop software, whenever you create a repair ticket, there is a checklist where you can select the condition of the camera parts. Not only that, but you can also add pre- and post-repair images to improve the quality of your services and avoid any issues with customers.",
  },
];
        ...
        <div className="container-main relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-white/80 text-lg font-dm-sans leading-relaxed mb-8">
              Don't just record, chart your repair shop's growth with detailed breakdowns. Integrate with <span className="text-rd-mint font-semibold">PayPal</span>, and <span className="text-rd-mint font-semibold">AA Repairdesk</span> payments for smooth financial operations.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/contact" className="btn-primary px-8 py-3.5">Request a Demo</Link>
              <a href="https://app.aarepairdesk.co/register" className="border border-white/40 text-white px-8 py-3.5 rounded-full font-poppins font-semibold hover:bg-white/10 transition-colors">Start Free Trial</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-main relative z-10">
          ...
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-white/70 font-dm-sans text-lg leading-relaxed">
              Say goodbye to paperwork and spreadsheets. AA Repairdesk helps you manage every step of the repair process transparently—from intake to delivery. Whether it's creating and assigning tickets, or collecting order notes and images, we're with you every step of the way.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-rd-dark rounded-3xl p-8 md:p-14 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mb-10">
              ...
              <p className="text-white/70 font-dm-sans leading-relaxed">
                When you join AA Repairdesk, you don't just get a POS system built for camera repair shops, but a global community of repair business owners who help you grow and understand your business better.
              </p>
            </div>
