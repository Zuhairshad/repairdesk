...
const steps = [
  ...
  },
  {
    ...
    desc: 'We reach out to your referral. Once their repair shop signs up for a paid AA Repairdesk plan, the referral is marked successful.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
...
const faqs = [
  {
    ...
    a: 'This program is open for all our valuable AA Repairdesk customers.',
  },
  {
  ...
  {
    q: 'How will AA Repairdesk know I referred the customers?',
    a: 'Make sure to add your correct details to the referral form above. This is the only way AA Repairdesk can track your contribution.',
  },
  {
        ...
        <div className="container-main relative grid grid-cols-1 lg:grid-cols-[1.2fr_.8fr] gap-12 items-center">
          <div>
            ...
            <p className="text-white/75 text-lg font-dm-sans leading-relaxed mb-8 max-w-xl">
              Invite a repair store owner to AA Repairdesk and get $250 in Paypal for every successful referral subscription. Make as many referrals as you like and enjoy the rewards.
            </p>
      ...
      <section className="bg-white py-16 md:py-20 px-6">
        <div className="container-main">
          ...
          <p className="text-gray-500 font-dm-sans text-lg mb-12 text-center max-w-2xl mx-auto">
            Everything you need to know about earning rewards through the AA Repairdesk Referral Program.
          </p>
