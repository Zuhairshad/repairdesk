...
const webinars = [
  ...
  {
    title: 'AA Repairdesk Phone System for Repair Pros – A Fireside Chat',
    description:
      'In this candid discussion, Usman (CEO AA Repairdesk) sits down with Alex (Computer Repair Doctor Cleveland), Travis (Four Corners Repair Center), and Coby (The Hard Drive) to talk about their communication challenges—and how AA Repairdesk Phone System helped solve them.',
    speakers: 'Usman, Alex, Travis & Coby',
  },
  {
    title: 'How to Transform Your Business to Work Without You',
    description:
      "Tired of being tied to your repair shop 24/7? In this powerful webinar, Usman (AA Repairdesk) and Ben (ProFixerr) share proven strategies to build systems that let your repair business run smoothly—even when you're not around.",
    speakers: 'Usman & Ben',
  },
  {
    title: 'How to Train Your Repair Store Staff – AA Repairdesk x ProFixerr',
    description:
  ...
  },
  {
    ...
    description:
      'Learn proven digital marketing strategies from Ben (ProFixerr), along with Saad, Hamid, and Usman from AA Repairdesk, that attract and retain customers, and help you stand out in a crowded market, and enhance visibility.',
    speakers: 'Ben, Saad, Hamid & Usman',
  },
  {
    title: 'Boost Profits & Cut Risks with AA Repairdesk + M360 Integration',
    description:
      "Unlock the full replay of our exclusive M360 + AA Repairdesk webinar and discover how to streamline repairs, eliminate trade-in risks, and boost your shop's efficiency — anytime, at your convenience.",
  },
  {
  ...
  {
    title: "How to Leverage AA Repairdesk's Powerful Reporting Tool",
    description: '',
  },
  {
    title: 'New Repair Tickets Module, Membership Module, & Appointments Pro',
    description:
      'Discover the launch of 3 new exciting modules in AA Repairdesk – the new Repair Tickets Module, Membership Module, and Appointments Pro. Learn how these modules provide more control over your repairs, appointments, and revenue.',
  },
  {
    title: 'AA Repairdesk Automations with Jeff Baker from One Bite Technology',
    description:
      'Learn how to use AA Repairdesk automations to get real-time repair updates and monitor employee performance at your repair store. Jeff Baker (One Bite Technology) explains how to automate processes and boost productivity.',
    speakers: 'Jeff Baker',
  },
  {
    title: 'Unlock Higher Profits with Trade-Ins & Buy-Backs',
    description:
      'Learn how trade-ins can be more profitable than supplier purchases and how you can automate trade-ins with AA Repairdesk and Reusely. Jeff also shares some of his effective resale and pricing strategies to maximize profit margins.',
    speakers: 'Jeff Baker',
  },
];

const speakers = [
  { name: 'Usman', role: 'CEO, AA Repairdesk' },
