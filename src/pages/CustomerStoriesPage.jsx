...
const featuredStory = {
  ...
  location: 'Austin, TX',
  quote:
    'We were drowning in sticky notes and spreadsheets. RepairDesk replaced all of it overnight. Our ticket time got cut in half, and customers actually started leaving five-star reviews because they could track their repairs in real time.',
  results: [
...
const stories = [
  ...
  },
  {
    ...
    quote:
      'Tracking custom orders and serialized pieces was chaos before RepairDesk. Now every piece has a digital trail from intake to pickup.',
  ...
  },
  {
    ...
    quote:
      'Tracking drone serial numbers and logging repair history was impossible with our old system. RepairDesk makes it simple and searchable.',
  ...
  },
  {
    ...
    quote:
      'We scaled from one store to five in two years. RepairDesk grew with us — same system, same data, no migration headaches.',
      ...
      <section className="relative overflow-hidden bg-rd-dark text-white py-24 md:py-32 px-6">
        ...
        <div className="container-main max-w-5xl relative z-10 flex flex-col items-center text-center gap-6">
          ...
          <p className="text-white/65 text-lg md:text-xl font-dm-sans leading-relaxed max-w-2xl">
            ...
            around the world use RepairDesk to save time, delight customers, and grow revenue.
          </p>
        ...
        <div className="container-main max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="font-dm-sans text-gray-500 mt-3 max-w-lg mx-auto">
              Watch repair shop owners share their experience with RepairDesk in their own words.
            </p>
          </div>
      ...
      <section className="relative bg-gradient-to-br from-rd-teal to-[#014a50] text-white py-16 md:py-20 px-6 overflow-hidden">
        ...
        <div className="container-main max-w-3xl text-center relative z-10">
          ...
          <p className="font-dm-sans text-white/70 text-lg md:text-xl leading-relaxed mb-8 max-w-xl mx-auto">
            Using RepairDesk to run your repair shop? We would love to feature your journey and the results
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://app.repairdesk.co/register"
